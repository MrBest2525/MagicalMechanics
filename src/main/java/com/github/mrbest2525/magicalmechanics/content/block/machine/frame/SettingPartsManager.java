...
import com.github.mrbest2525.magicalmechanics.content.item.frameparts.instance.SettingPartsExecutionPhase;
...
public class SettingPartsManager {
    ...
    public void load(ListTag list, HolderLookup.Provider provider) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            // ItemStackの復元
            PartItemStack stack = stack = PartItemStack.load(compound.getCompound("Stack"), provider);
