...
import com.github.mrbest2525.magicalmechanics.api.gui.SoraUI;
import com.github.mrbest2525.magicalmechanics.api.gui.SoraUIContainerScreen;
import net.minecraft.network.chat.Component;
import net.minecraft.resources.ResourceLocation;
import net.minecraft.world.entity.player.Inventory;

public class FrameBlockSettingPartsScreen extends SoraUIContainerScreen<FrameBlockSettingPartsMenu> {
    ...
    @Override
    protected ResourceLocation loadFile() {
        return null;
    }
    
    @Override
    protected void bindRenderer(SoraUI soraUI) {
