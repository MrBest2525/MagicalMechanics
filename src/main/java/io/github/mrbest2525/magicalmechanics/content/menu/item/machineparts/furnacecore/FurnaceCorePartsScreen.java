package io.github.mrbest2525.magicalmechanics.content.menu.item.machineparts.furnacecore;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.mojang.math.Axis;
import io.github.mrbest2525.magicalmechanics.MagicalMechanics;
import io.github.mrbest2525.magicalmechanics.content.menu.item.machineparts.util.furnace.ThermalUtil;
import io.github.mrbest2525.magicalmechanics.content.menu.util.GuiLayout;
import io.github.mrbest2525.magicalmechanics.content.menu.util.PlayerInventoryUtil;
import io.github.mrbest2525.magicalmechanics.util.MMTextures;
...
//        this.renderTransparentBackground(guiGraphics);
    ...
    protected void renderBg(@NotNull GuiGraphics guiGraphics, float v, int i, int i1) {
        ...
        guiGraphics.pose().translate(0, 0, -16 * (fireStandScale / 2));
        guiGraphics.pose().translate(-8, -8, 0);
        guiGraphics.renderFakeItem(this.menu.slots.get(37).getItem(), 0, 0);
        guiGraphics.pose().popPose();
    }
